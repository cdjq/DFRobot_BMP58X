...
def setup():
    ...
    '''!
      ...
      3. bmp5.OOR_COUNT_LIMIT_1 - Threshold for consecutive out-of-range readings before triggering an OOR event
    ...
    '''
    bmp5.set_oor_press(94658, 50, bmp5.OOR_COUNT_LIMIT_1)
    ...
    '''
    bmp5.set_int_source(bmp5.INT_PRESSURE_OOR)
