/**
 * @file  getDataSingleMode.ino
 * @brief  This program demonstrates how to use the BMP58x pressure sensor in single acquisition mode.
...
void setup() {
   ...
   */
  bmp58x.setMeasureMode(bmp58x.eSingleShot);
